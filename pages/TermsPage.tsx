...
export const TermsPage: React.FC<TermsPageProps> = ({ onBack }) => {
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] dark:bg-slate-950 text-slate-900 dark:text-slate-100 font-sans selection:bg-blue-100 dark:selection:bg-blue-900 selection:text-blue-900 dark:selection:text-blue-100 transition-colors">
      {/* Background Elements */}
      <div className="fixed inset-0 w-full h-full bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:24px_24px] pointer-events-none z-0 dark:opacity-20"></div>
      <div className="fixed top-0 left-0 w-full h-[500px] bg-gradient-to-b from-white via-transparent to-transparent pointer-events-none z-0 dark:from-slate-900"></div>
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200/50 dark:border-slate-800/50">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3 cursor-pointer" onClick={onBack}>
            <div className="bg-slate-900 dark:bg-slate-100 p-2 rounded-lg shadow-lg shadow-slate-900/20 dark:shadow-slate-100/10">
          ...
          <Button variant="ghost" size="sm" onClick={onBack} className="gap-2 group dark:text-slate-300 dark:hover:text-white dark:hover:bg-slate-800">
      ...
      <div className="max-w-7xl mx-auto px-6 pt-32 pb-24 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-12 items-start">
          ...
          <main className="min-w-0">
            <FadeIn>
              <div className="bg-slate-900 dark:bg-slate-800 text-white rounded-3xl p-8 md:p-12 shadow-2xl shadow-slate-900/10 mb-12 relative overflow-hidden border border-transparent dark:border-slate-700">
            ...
            <div className="space-y-16">
                {/* Introduction */}
                <FadeIn delay={100}>
                    <section id="intro" className="prose prose-slate dark:prose-invert max-w-none">
                ...
                <FadeIn delay={200}>
                    <section id="advice" className="scroll-mt-32">
                        ...
                        <div className="bg-blue-50 dark:bg-blue-900/20 rounded-2xl p-8 border border-blue-100 dark:border-blue-800 shadow-[0_2px_20px_rgba(59,130,246,0.1)]">
                            <div className="flex gap-4">
                                <div className="h-10 w-10 rounded-full bg-blue-100 dark:bg-blue-800 flex items-center justify-center shrink-0 text-blue-600 dark:text-blue-300">
                                    <Shield className="h-5 w-5" />
                                </div>
                                <div>
                                    <h3 className="text-blue-900 dark:text-blue-300 font-bold mb-2">Important Disclaimer</h3>
                ...
                <FadeIn delay={350}>
                    <section id="content" className="scroll-mt-32">
                        ...
                        <div className="bg-slate-50 dark:bg-slate-800/50 rounded-xl p-6 border border-slate-200 dark:border-slate-800">
                            <p className="font-medium text-slate-900 dark:text-slate-100 mb-3">You acknowledge that:</p>
                ...
                <FadeIn delay={400}>
                    <section id="citations" className="scroll-mt-32">
                        ...
                        <ul className="grid sm:grid-cols-2 gap-4">
                            <li className="flex items-center gap-3 bg-white dark:bg-slate-900 p-4 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm text-sm font-medium text-slate-700 dark:text-slate-300">
                    ...
                    <section id="privacy" className="scroll-mt-32">
                        ...
                        <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 overflow-hidden shadow-sm">
                            <div className="p-6 border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/30">
                                <h4 className="font-bold text-slate-900 dark:text-slate-100 mb-4">Data Collection</h4>
                                <ul className="space-y-2">
                            ...
                            <div className="p-6 bg-red-50/30 dark:bg-red-900/10">
                                ...
                                <p className="text-sm text-red-600 dark:text-red-300 mb-3 font-medium">Do not submit:</p>
                                <ul className="space-y-2 mb-4">
                                    <ListItem className="text-red-700 dark:text-red-300">Highly sensitive personal information (medical, biometric, financial)</ListItem>
                                    <ListItem className="text-red-700 dark:text-red-300">Confidential data you wouldn't want disclosed in a breach</ListItem>
                                </ul>
                ...
                <FadeIn delay={550}>
                    <section id="safety" className="scroll-mt-32">
                        ...
                        <p className="text-slate-600 dark:text-slate-300 leading-relaxed mb-4">You agree not to use the App to:</p>
                        <ul className="space-y-3">
                ...
                <FadeIn delay={700}>
                    <section id="disclaimer" className="scroll-mt-32">
                        ...
                        <div className="bg-slate-100 dark:bg-slate-900 rounded-2xl p-8 border border-slate-200 dark:border-slate-800">
                            <p className="text-slate-700 dark:text-slate-300 leading-relaxed font-medium font-serif italic">
                ...
                <FadeIn delay={750}>
                    <section id="liability" className="scroll-mt-32">
                        ...
                        <div className="p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm mb-6">
                            <p className="text-slate-800 dark:text-slate-200 font-medium uppercase tracking-wide text-xs mb-4 text-center text-slate-400">Liability Cap</p>
                            <div className="text-center">
                                <span className="text-4xl font-bold text-slate-900 dark:text-slate-100">$50 CAD</span>
                                <span className="block text-sm text-slate-500 dark:text-slate-400 mt-2">or amount paid in past 3 months</span>
                            </div>
                        </div>
                        <p className="text-slate-600 dark:text-slate-300 leading-relaxed mb-4 text-sm uppercase font-medium">
                    ...
                    <div className="space-y-16">
                        ...
                        <section id="contact" className="scroll-mt-32">
                            ...
                            <div className="bg-white dark:bg-slate-900 rounded-2xl p-8 border border-slate-200 dark:border-slate-800 shadow-lg text-center">
                                <p className="text-slate-600 dark:text-slate-300 mb-4">Questions about these Terms?</p>
                                <a 
                                    href="mailto:support@rcicassistant.com" 
                                    className="inline-flex items-center justify-center px-6 py-3 rounded-full bg-slate-900 dark:bg-slate-100 text-white dark:text-slate-900 font-medium hover:bg-slate-800 dark:hover:bg-slate-200 transition-colors shadow-lg shadow-slate-900/20"
                                >
                                    Contact Support
                                </a>
                            </div>
          ...
          <aside className="hidden lg:block sticky top-28 h-[calc(100vh-140px)] overflow-y-auto pr-4 custom-scrollbar">
             <div className="bg-white/50 dark:bg-slate-900/50 backdrop-blur-sm rounded-2xl border border-slate-200/60 dark:border-slate-800/60 p-6 shadow-sm">
                <div className="flex items-center gap-2 mb-6 text-slate-900 dark:text-slate-100 font-bold font-serif">
                        ...
                        <button
                            ...
                            className={cn(
                                ...
                                activeSection === section.id
                                    ? "border-blue-500 text-slate-900 dark:text-slate-100 font-bold bg-blue-50/50 dark:bg-blue-900/20 rounded-r-lg"
      ...
      <footer className="bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 mt-24">
        <div className="max-w-7xl mx-auto px-6 py-12 flex flex-col md:flex-row justify-between items-center gap-6">
            <p className="text-sm text-slate-500 dark:text-slate-400">© 2026 RCIC Assistant. All rights reserved.</p>
            <div className="flex gap-6">
                <Button variant="outline" size="sm" onClick={onBack} className="dark:text-slate-300 dark:border-slate-700 dark:hover:bg-slate-800">
                    Back to Home
                </Button>
            </div>
        </div>
...
const SectionHeader = ({ number, title }: { number: string, title: string }) => (
    <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100 mb-6 flex items-center gap-4 group">
        <span className="flex items-center justify-center h-10 w-10 rounded-xl bg-slate-50 dark:bg-slate-800 text-slate-400 dark:text-slate-500 text-sm font-bold border border-slate-200 dark:border-slate-700 group-hover:border-blue-500 group-hover:text-blue-600 group-hover:bg-blue-50 dark:group-hover:bg-blue-900/20 transition-all shadow-sm">
            {number}
        </span>
...
const ListItem = ({ children, className }: { children: React.ReactNode, className?: string }) => (
    <li className={cn("flex items-start gap-3 text-slate-600 dark:text-slate-300 leading-relaxed", className)}>
        <div className="h-1.5 w-1.5 rounded-full bg-slate-300 dark:bg-slate-600 mt-2.5 shrink-0"></div>
        <span>{children}</span>
    </li>
);
